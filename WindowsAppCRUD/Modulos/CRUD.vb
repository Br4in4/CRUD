...
AttachDbFilename =|DataDirectory|\DBusers.mdf;Integrated Security=True")
    End Function
    ...
    Public Sub Create(ByVal Comando As String)
        Try
            ...
            With cmd
                ...
                If resultado = 0 Then
                    MessageBox.Show("Falhou a operacao de inserir os dados.",
    ...
    Public Sub Updates(ByVal Comando As String)
        Try
            ...
            With cmd
                ...
                If resultado = 0 Then
                    MessageBox.Show("Falhou a operacao de atualizar os dados.",
    ...
    Public Sub Delete(ByVal Comando As String)
        Try
            ...
            With cmd
                ...
                resultado = cmd.ExecuteNonQuery
                If resultado = 0 Then
                    MessageBox.Show("Falhou a operacao de eliminar os dados.",
                                    "Erro!", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Else
